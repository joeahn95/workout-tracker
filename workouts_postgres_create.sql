...
CREATE TABLE public.exerciseList (
	...
	"vid_link" varchar,
	"equip_req" boolean,
	CONSTRAINT "exerciseList_pk" PRIMARY KEY ("_id")
) WITH (
  OIDS=FALSE
);

INSERT INTO public.exerciseList VALUES (1, 'Bench Press', 'https://www.youtube.com/watch?v=rxD321l2svE&ab_channel=StartingStrength', TRUE);
INSERT INTO public.exerciseList VALUES (2, 'Squat', 'https://www.youtube.com/watch?v=xqvCmoLULNY&ab_channel=XHITDaily', FALSE);
INSERT INTO public.exerciseList VALUES (3, 'Deadlift', 'https://www.youtube.com/watch?v=r4MzxtBKyNE&ab_channel=Men%27sHealth', TRUE);
INSERT INTO public.exerciseList VALUES (4, 'Skull Crushers', 'https://www.youtube.com/watch?v=r4MzxtBKyNE&ab_channel=Men%27sHealth', TRUE);
INSERT INTO public.exerciseList VALUES (5, 'Barbell Squat', 'https://www.youtube.com/watch?v=r4MzxtBKyNE&ab_channel=Men%27sHealth', TRUE);
INSERT INTO public.exerciseList VALUES (6, 'Chest Flies', 'https://www.youtube.com/watch?v=r4MzxtBKyNE&ab_channel=Men%27sHealth', TRUE);
INSERT INTO public.exerciseList VALUES (7, 'Box Jumps', 'https://www.youtube.com/watch?v=r4MzxtBKyNE&ab_channel=Men%27sHealth', TRUE);


CREATE TABLE public.workoutList (
	"_id" serial NOT NULL,
	"name" varchar NOT NULL,
	CONSTRAINT "workoutList_pk" PRIMARY KEY ("_id")
) WITH (
  OIDS=FALSE
);

INSERT INTO public.workoutList VALUES (1, 'Chest & Triceps');
INSERT INTO public.workoutList VALUES (2, 'Legs');

CREATE TABLE public.workout_to_exercise (
	"_id" serial NOT NULL,
	"workout_id" int,
	"exercise_id" int,
